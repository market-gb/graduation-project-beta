package ru.market_gb.core.controllers;
...
public class OrdersController {
    ...
    @PutMapping("/{id}")
    public void changeStatus(@Parameter(description = "Статус заказа", required = true)@RequestBody Order.OrderStatus orderStatus,
